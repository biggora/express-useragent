...
exports['electron 1.8.3 Mac 10.13.3'] = function (test) {
  var ua = Ua.parse(
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) electron-app-name/1.0.0 Chrome/59.0.3071.115 Electron/1.8.3 Safari/537.36',
  );
...
exports['electron 8.2.3 Mac 10.14.6'] = function (test) {
  var ua = Ua.parse(
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) electron-app/0.0.1 Chrome/80.0.3987.163 Electron/8.2.3 Safari/537.3',
  );
