...
(function(exports) {
    ...
    var UserAgent = function () {
        ...
        this.testBot = function testBot() {
            var ua = this;
            if (/googlebot|baiduspider|gurujibot|yandexbot|slurp|msnbot|bingbot|facebookexternalhit|linkedinbot|twitterbot|slackbot|telegrambot/i.test(ua.Agent.source)) {
                ua.Agent.isBot = true;
            }
        };
