...
(function(exports) {
    ...
    /**
     * Constructor of default value getter.
     *
     * @param {function} getter - Function which returns any value.
     *
     * @returns {DefaultValue} Instance of DefaultValue.
     */
    function DefaultValue(getter) {
        this.getter = getter;
    }

    /**
     * Returns the call result of `this.getter`.
     *
     * @returns {*} Any result of `this.getter`.
     */
    DefaultValue.prototype.getValue = function() {
        return this.getter();
    };
    ...
    var defaultAgent = {
        ...
        platform: 'unknown',
        /*
         * The object and arrays will be set by reference, due to this all copies will be the same.
         * To avoid this problem the getter should be called on set. Here the `DefaultValue` wrapper
         * is used for detect if the value is getter and not just function value.
         */
        geoIp: new DefaultValue(function() { return {}; }),
        source: ''
    };

    /**
     * Constructor of user agent details.
     *
     * @param {string} [source=''] - The user agent string.
     * @param {object} [headers] - Request headers with GEO information.
     *
     * @returns {UserAgent} Instance of UserAgent.
     */
    function UserAgent(source, headers) {
        /* Fallback for call constructor without operator `new`. */
        ...
        if (headers && typeof headers === 'object') {
            this.testNginxGeoIP(headers);
        }

        /* The fallback for previous solution. */
        this.DefaultAgent = {};
     ...
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Name of the browser (the boolean flag like `is${BrowserName}` will be set as side effect).
     */
    ...
    /**
     * Gets the browser version by user agent.
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Version of the browser or 'unknown'.
     */
    ...
    /**
     * Gets the wechat version by user agent.
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Version of the wechar or 'unknown'.
     */
    ...
    /**
     * Gets the electron version by user agent.
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Version of the electron or 'unknown'.
     */
    ...
    /**
     * Gets the OS name by user agent. Be careful that function has the side effects related to `this.Agent` state.
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Name of the OS (the boolean flag like `is${OS}` will be set as side effect).
     */
    UserAgent.prototype.getOS = function (string) {
        ...
        switch (true) {
            ...
            case _OS.Mac.test(string):
                if (isBrowser && window.navigator.platform === 'MacIntel' && window.navigator.maxTouchPoints > 1) {
    ...
    /**
     * Gets the platform name by user agent. Be careful that function has the side effects related to `this.Agent` state.
     *
     * @param {string} [string=this.Agent.source] - The user agent.
     *
     * @returns {string} Name of the platform (the boolean flag like `is${Platform}` will be set as side effect).
     */
    ...
    /**
     * Checks if the compatibility mode is enabled for Internet Explorer.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isIECompatibilityMode` and `version` will be set as side effect.
     */
    ...
    /**
     * Checks if user agent is Silk.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isSilk` and `SilkAccelerated` will be set as side effect.
     */
    ...
    /**
     * Checks if user agent is Kindle Fire.
     * Be careful that function has the side effects related to `this.Agent`.
     *
     * @returns {string} Name of Kindle Fire, the boolean flag `isKindleFire` will be set as side effect.
     */
    ...
    /**
     * Checks if user agent is Captive Network.
     * Be careful that function has the side effects related to `this.Agent`.
     *
     * @returns {string} Name of Captive Network, the boolean flag `isCaptive` and `isMac` and `platform='Apple Mac'` string will be set as side effect.
     */
    ...
    /**
     * Checks if the parsed agent uses the mobile browsers\os.
     * Be careful that function has the side effects related to `this.Agent` state of the boolean
     * flag `isDesktop`, `isMobile`, `isAndroidNative`, `isMobileNative` and `isiPhoneNative` will
     * be set as side effect.
     */
    ...
    /**
     * Checks if the parsed agent is table.
     * Be careful that function has the side effects related to `this.Agent` state of the boolean
     * flag `isTablet` will be set as side effect.
     */
    ...
    /**
     * Copies the GEOIP headers to `Agent.geoIp`.
     * Be careful that function has the side effects related to `this.Agent`.
     *
     * @param {object} headers - Request headers.
     *
     * @returns {UserAgent} Current instanse of UserAgent.
     */
    ...
    /**
     * Checks if the user agent is bot.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * string\boolean flag `isBot` will be set as side effect.
     */
    ...
    /**
     * Checks if the user agent is smart tv.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isSmartTV` will be set as side effect.
     */
    ...
    /**
     * Checks if the user agent is android tablet.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isAndroidTablet` will be set as side effect.
     */
    ...
    /**
     * Checks if the user agent is a apple webkit browser.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isWebkit` and string `browser='Apple WebKit'`  will be set as side effect.
     */
    ...
    /**
     * Checks if the user agent is a wechat.
     * Be careful that function has the side effects related to `this.Agent` state of the
     * boolean flag `isWechat` and string `version` will be set as side effect.
     */
    ...
    /**
     * Checks if the user agent is a webview of android or iOS.
     * Be careful that function has the side effects related to `this.Agent` state of the
    ...
    /**
     * @deprecated
     * Method for parse the user agent, like a static but attached to instance.
     *
    ...
    UserAgent.parse = function (source) {
        var ua = new UserAgent(source);
        return ua.Agent;
    };

    /**
     * Static method for check NginxGeoIP.
     *
     * @param {object} headers - Request headers.
     *
     * @returns {UserAgent} Instance of UserAgent with `Agent.geoIp`.
     */
    UserAgent.testNginxGeoIP = function (headers) {
        return new UserAgent(null, headers);
    };
